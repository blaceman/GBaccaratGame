...
static float const kNavBarHeight = 64.0f;
static float const kTabbarHeight = 49.0f;

#pragma mark - static method

#define isDictionary(object)  [object isKindOfClass:[NSDictionary class]]
#define isArray(object) [object  isKindOfClass:[NSArray class]]
#define isEqualString(str1,str2)   [str1 isEqualToString:str2]
#define isKindClass(class1,class2)  [class1 isKindOfClass:NSClassFromString(class2)]
#define noNillString(object)  IsEmpty(object) ? @"" : object
...
static inline BOOL IsEmpty(id thing) {
    ...
    || ([thing isKindOfClass:[NSNumber class]]
        && [(NSNumber *)thing doubleValue] == 0);
}
